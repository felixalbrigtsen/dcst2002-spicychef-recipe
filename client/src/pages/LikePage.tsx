...
export default function LikePage() {
    ...
    return (
      ...
      <Tile kind="child" renderAs={Notification} color="success" className="has-text-centered is-12">
          <Heading> Your Liked Recipes </Heading> 
      </Tile>
      <Columns className="is-multiline" style={{marginTop: '2rem', marginLeft: 'auto', marginRight: 'auto'}}>
