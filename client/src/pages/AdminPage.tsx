...
function AdminView() {
  ...
  function handleDelete(id: number) {
    ...
    recipeService
      .deleteRecipe(id)
      .then(() => {
        appendAlert("Recipe deleted successfully", "success");
        updateRecipeList();
      })
      .catch(() => {
        appendAlert("Recipe deletion failed", "danger");
      });
    setConfirmationState(!confirmationState);
    setConfirmItem(-1);
  }
              ...
              >
                ...
                <Tile className="is-justify-content-space-evenly">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      recipeService
                        .importRecipe(mealDBRecipe)
                        .then(() => {
                          appendAlert("Recipe imported successfully", "success");
                          updateRecipeList();
                        })
                        .catch(() => {
                          appendAlert("Recipe import failed", "danger");
                        });
                    }}
                  >
